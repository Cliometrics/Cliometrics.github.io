...
link_url <- c("https://www.nber.org/papers/w26410",
...
table %>% 
  ...
  kableExtra::kable_styling(full_width = F, bootstrap_options = 'striped')#c("hover", "condensed"))
